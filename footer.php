...
<?php
if ( ( ( !isset($_COOKIE['greentv_location']) || $_COOKIE['greentv_location'] == 'unknown' ) && ( !isset($_GET['set_location']) ) ) ||
     ( isset($_GET['set_location']) && $_GET['set_location'] == 'unknown' )
   ) :
?>
    ...
    <div id="map-choice">
        <p>
            ...
            <div style="text-align : center">
                <a class="button submit world-map" rel="world-en" href="?set_location=en">Main Site</a>
                <a class="button submit world-map" rel="world-sp" href="?set_location=sp">South Pacific</a>
            </div>
        </p>
        ...
        <div id="map-container">
            ...
            <map name="image_map" id="image_map">
                ...
                <area href="?set_location=sp" shape="poly" coords=" 62,474, 85,464, 121,468, 125,456, 178,458, 184,440, 219,406, 213,472, 285,473, 297,457, 328,439, 394,439, 431,424, 480,439, 490,424, 585,422, 646,450, 659,454, 649,475, 698,474, 698,338, 671,338, 657,357, 650,353, 663,322, 648,292, 628,303, 615,348, 587,319, 551,327, 546,295, 580,274, 607,274, 604,252, 698,256, 698,337" rel="world-sp" class="world-map" alt="green hotspot"/>
            </map>

            <img src="<?php bloginfo( 'template_directory' ); ?>/images/world.png" alt="World map" id="world-map" />
        </div>
    </div>
<?php endif; ?>
</body>
